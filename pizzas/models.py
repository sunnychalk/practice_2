...
class Pizza(models.Model):
    ...
    photo = models.ImageField(
        upload_to='static/pizzas/', default='static/pizzas/no_photo.png'
    )
...
class InstancePizza(models.Model):
    ...
    pizza_template = models.ForeignKey(
        Pizza, related_name='pizza_template', null=True,
    ...
    def __str__(self):
        return 'name: {}, price: {}, count: {}'.format(
            self.name, str(self.price), str(self.count)
        )
